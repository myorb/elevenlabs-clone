...
class CLAPWrapper():
    ...
    def __init__(self, model_fp, device):
        ...
        self.config_as_str = files('ldm').joinpath(
            'modules/encoders/CLAP/config.yml').read_text()
    ...
    def get_text_embeddings(self, class_labels):
        ...
        text_embeddings = text_embeddings / \
            torch.norm(text_embeddings, dim=-1, keepdim=True)
    ...
    def get_audio_embeddings(self, audio_files, resample):
        ...
        audio_embeddings = audio_embeddings / \
            torch.norm(audio_embeddings, dim=-1, keepdim=True)
...
if __name__ == '__main__':
    ...
    y = ["A woman talks nearby as water pours",
         "Multiple clanging and clanking sounds"]
    x = ['/home2/huangjiawei/data/audiocaps/train/Yr1nicOVtvkQ.wav',
    ...
    similarity = clap_model.compute_similarity(
